...
function checkLoginItem(path, id) {
    $.ajax({
        ...
        type: 'GET',
        data: 'perm_edit_gear=' + true + "&id=" + id,
...
function take_item(path) {
    var id = localStorage.getItem("storageIDGear");
    $.ajax({
        url: path + 'php/posts_gear.php',
        type: 'GET',
        ...
        success: function(data){
            ...
            document.getElementById("idi").innerHTML = "#" + resp[9];
            document.getElementById("more_details").innerHTML = resp[9] ? resp[9] : "Nothing to show";
            document.getElementById("single_parental").innerHTML = resp[10] === "1" ? "Yes" : "No";
            checkLoginItem(path, resp[9]);
            ...
            var pathImg = path + 'profile/' + resp[0] + '/' + resp[9] + 'G_1.jpg?' + new Date().getTime();
...
function editItem(path = "") {
    ...
    setTimeout(function(){
        ...
        $.ajax({
            url: path + 'php/posts_gear.php',
            type: 'POST',
            data: 'update_post_gear=' + true + "&id=" + idItem + "&username=" + user + "&title=" + title + "&artists=" + artists + "&language=" + language + "&currency=" + currency + "&price=" + price + "&genre=" + genre + "&date=" + date + "&details=" + details + "&exp=" + exp,
            success: function(data){
                console.log(data);     
